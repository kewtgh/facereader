...
redirect_from:
  - /docs/%E7%BB%8F%E5%85%B8%E8%A7%A3%E8%AF%BB/%E5%AD%99%E5%AD%90%E5%85%B5%E6%B3%95/TheArtofWar-5bingshi/
...
“分数”的意思是，分工，分队，分层，分组，分职责，分级管理系统。就是清晰的分层结构。古代没有现代的通讯设施，十万大军如果没有统一的信号调度，分分钟就会成为十万溃军。最著名的案例就是淝水之战。

公元383年，前秦苻坚领着步兵六十余万、骑兵二十七万、羽林军三万余骑攻打东晋，结果因为人数太多，前边的队伍后撤，后面的退伍以为是战败，结果轰然之间溃散，百万大军成了百万人潮浑水，仅仅被自己人踩死的都不计其数。百万大军最后只剩十万人。

即使通讯发达的现代军队，清晰的组织架构也是军队中最重要的部分。
...
“势”是一种来自整体结构的巨大能量。不是靠蛮力，而是靠长期积累、正确布局后的自然爆发。

“节”指节奏、时机、触发点、动作的刹那性，讲求短、准、快。所以意思是指爆发的那一刻。
...
混乱，是在秩序遭到破坏时产生的；怯懦，是在勇气瓦解后出现的；弱势，是强势击穿后发生的。

严整和混乱，取决于秩序规则；勇敢和怯懦，取决于军情局势；强大和弱小，取决于结构情形。

因此，善于调动敌军的人，向敌军塑造一种态势，敌军就一定会跟随你设定的方向；给敌军利益诱惑，敌军就一定会进军讨取。用利益调动敌军，用劲卒严阵以待。
...
善于利用有利态势的人，他们指挥军队作战，就如同转动木头和石头一样。木头和石头的特性是：在安稳平坦之处则静止，在陡斜峻险之处则滚动；形状方正则静止，形状圆滑则滚动。因此善于作战的人所创造的势，就如同圆石从万丈高山上滚下来一样，势不可挡，这就是“势”的力量！

以上就是《兵势篇》的所有内容。《兵势篇》的几点**主要内容**：
...
首先是含义的区别，“形”指静态的、人为设计的、结构性的，往往是指布阵、地形利用、兵力部署、谋略的预设和资源配置等。“势”指通过布局形成的、积累性的、自然爆发的力量，是从结构中产生的动态力量。

二者的关系，**势来源于“形”**，形是布局，势是布局效果。
